...
var ProductLogic = /** @class */ (function (_super) {
    ...
    ProductLogic.prototype.getAllDisplayProducts = function (_a) {
        var _this = this;
        var limit = _a.limit, chunk = _a.chunk, type = _a.type, storeId = _a.storeId;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var query, productData, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    ProductLogic.prototype.getAllProductsOptimized = function (_a) {
        var _b = _a.limit, limit = _b === void 0 ? 100 : _b, _c = _a.chunk, chunk = _c === void 0 ? 0 : _c, type = _a.type, userId = _a.userId, isFeatured = _a.isFeatured, categoryId = _a.categoryId;
        return __awaiter(this, void 0, void 0, function () {
            var wishListData, allWishListArray, cartItemData, allCartItemArray, query, products, totalLength;
