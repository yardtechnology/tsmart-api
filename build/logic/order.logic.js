...
var OrderLogic = /** @class */ (function (_super) {
    ...
    OrderLogic.prototype.placeSellOrder = function (_a) {
        var userId = _a.userId, paymentMethod = _a.paymentMethod, makeId = _a.makeId, modelId = _a.modelId, deviceId = _a.deviceId, falsyEvaluatedIds = _a.falsyEvaluatedIds, addressId = _a.addressId, bankDetails = _a.bankDetails, colorId = _a.colorId, memoryId = _a.memoryId, imei = _a.imei;
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_b) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            switch (_a.label) {
                                case 0:
                                    ...
                                    console.log({
                                        ...
                                        modelId: modelId,
                                        deviceId: deviceId,
                                        falsyEvaluatedIds: falsyEvaluatedIds,
                                        addressId: addressId,
    ...
    OrderLogic.prototype.sendInvoiceToMail = function (_a) {
        var _b, _c, _d;
        var orderId = _a.orderId, mail = _a.mail, isDownload = _a.isDownload;
        return __awaiter(this, void 0, void 0, function () {
            var orderData, invoiceTemplate, baseDir, htmlFilePath, browser, page, pdf, mailOptions, error_5;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        invoiceTemplate = orderData === null || orderData === void 0 ? void 0 : orderData.invoiceHTML;
                        baseDir = path_1.default.join(__dirname, "..", "..", "uploads");
                        htmlFilePath = "".concat(baseDir, "/invoice-").concat((_b = orderData === null || orderData === void 0 ? void 0 : orderData.orderData) === null || _b === void 0 ? void 0 : _b._id, ".html");
                        return [4 /*yield*/, promises_1.default.writeFile(htmlFilePath, invoiceTemplate)];
                    case 2:
                        _e.sent();
                    ...
                    case 4:
                        page = _e.sent();
                        return [4 /*yield*/, page.goto(htmlFilePath, {
                    ...
                    case 6:
                        pdf = _e.sent();
                        return [4 /*yield*/, promises_1.default.rm(htmlFilePath)];
                    case 7:
                        _e.sent();
                        mailOptions = {
                            from: process.env.EMAIL,
                            to: mail,
                            subject: "Invoice for your ride ".concat((_c = orderData === null || orderData === void 0 ? void 0 : orderData.orderData) === null || _c === void 0 ? void 0 : _c._id),
                            html: invoiceTemplate,
                            attachments: [
                                {
                                    filename: "invoice-".concat((_d = orderData === null || orderData === void 0 ? void 0 : orderData.orderData) === null || _d === void 0 ? void 0 : _d._id, ".pdf"),
                                    content: pdf,
                                },
                            ],
                        };
