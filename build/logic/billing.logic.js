...
var BillingLogic = /** @class */ (function (_super) {
    ...
    BillingLogic.prototype.createBill = function (_a) {
        var orderIds = _a.orderIds, price = _a.price, mrp = _a.mrp, razorpay_payment_id = _a.razorpay_payment_id, razorpay_order_id = _a.razorpay_order_id, razorpay_signature = _a.razorpay_signature, payment_order_id = _a.payment_order_id, status = _a.status, couponId = _a.couponId, userId = _a.userId;
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_b) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var configData, total, couponValue, couponData, tax, subPrice, bill, error_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 3:
                                    ...
                                    _a.label = 4;
                                case 4:
                                    tax = (configData === null || configData === void 0 ? void 0 : configData.tax) ? (total * (configData.tax || 1)) / 100 : 0;
                                    subPrice = total - tax;
    ...
    BillingLogic.prototype.calculateItemBilling = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, models_1.CouponSchema.findById(couponId)];
                    case 1:
                        configData = _b.sent();
                            ...
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, new billing_model_1.BillingModel({
                                            orders: ordersIdArr,
                                            subTotal: basePrice,
                                            tax: (configData === null || configData === void 0 ? void 0 : configData.tax) ? (basePrice * (configData.tax || 1)) / 100 : 0,
                            ...
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, billing_model_1.BillingModel.findOneAndUpdate({
                                            ...
                                            subTotal: basePrice,
                                            tax: (configData === null || configData === void 0 ? void 0 : configData.tax)
