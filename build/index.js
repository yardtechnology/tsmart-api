...
var incomingBooking_socket_1 = __importDefault(require("./socket/incomingBooking.socket"));
var position_socket_1 = __importDefault(require("./socket/position.socket"));
var service_socket_1 = __importDefault(require("./socket/service.socket"));
...
var App = /** @class */ (function () {
    ...
    App.prototype.listen = function () {
        ...
        this.server.listen(this.PORT, function () {
            _this.Io.of("/incoming-job").on("connection", (0, incomingBooking_socket_1.default)(_this.Io));
            _this.Io.of("/service").on("connection", (0, service_socket_1.default)(_this.Io));
            _this.Io.of("/position").on("connection", (0, position_socket_1.default)(_this.Io));
