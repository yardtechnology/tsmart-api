...
var Order = /** @class */ (function (_super) {
                ...
                switch (_u.label) {
                    ...
                    case 3:
                        new notification_logics_1.default().pushNotification({
                            ...
                            body: "Your order ".concat(orderData === null || orderData === void 0 ? void 0 : orderData._id, " is ").concat((_k = orderData === null || orderData === void 0 ? void 0 : orderData.status) === null || _k === void 0 ? void 0 : _k.replace(/_/g, " ")),
                        });
                        return [3 /*break*/, 8];
                    case 4:
                    ...
                    case 7:
                        new notification_logics_1.default().pushNotification({
                            ...
                            body: "Your order ".concat(orderData === null || orderData === void 0 ? void 0 : orderData._id, " is ").concat((_q = orderData === null || orderData === void 0 ? void 0 : orderData.status) === null || _q === void 0 ? void 0 : _q.replace(/_/g, " ")),
                        });
                        new mail_controller_1.default().sendMail({
                            to: orderData.user.email,
                            subject: "Order status updated",
    ...
    Order.prototype.placeCartOrderController = function (req, res, next) {
        var _a, _b, _c, _d, _e;
        return __awaiter(this, void 0, void 0, function () {
            var cartItemList, orderedItems, _i, _f, cartItem, orderData, orderIds, price, billingData, error_12;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        _g.trys.push([0, 7, , 8]);
                    ...
                    case 1:
                        cartItemList = _g.sent();
                        orderedItems = [];
                        _i = 0, _f = cartItemList.products;
                        _g.label = 2;
                    case 2:
