...
var ReviewController = /** @class */ (function () {
    ...
    ReviewController.prototype.create = function (req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _b, comment, ratings, productId, storeId, technicianId, orderId, user, queryArg, reviewDevice, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 8, , 9]);
                        (0, helper_1.fieldValidateError)(req);
                        _b = req.body, comment = _b.comment, ratings = _b.ratings, productId = _b.productId, storeId = _b.storeId, technicianId = _b.technicianId, orderId = _b.orderId;
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, product_model_1.ProductModel.findByIdAndUpdate(technicianId, {
                                $inc: {
                                    "reviews.total": 1,
                                    "reviews.stars": Number(ratings),
                                },
    ...
    ReviewController.prototype.getAll = function (req, res, next) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var _b, limit, chunk, reviewId, storeId, productId, userId, technicianId, orderId, query, getAllData, error_2;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        _b = req.query, limit = _b.limit, chunk = _b.chunk, reviewId = _b.reviewId, storeId = _b.storeId, productId = _b.productId, userId = _b.userId, technicianId = _b.technicianId, orderId = _b.orderId;
                        query = {};
