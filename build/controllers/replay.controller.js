...
var ReplayController = /** @class */ (function () {
    ...
    ReplayController.prototype.replay = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, subject, body_1, userId, isEmailSend, isNotification, email, _b, userData, _c, error_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 7, , 8]);
                        _a = req.body, subject = _a.subject, body_1 = _a.body, userId = _a.userId, isEmailSend = _a.isEmailSend, isNotification = _a.isNotification, email = _a.email;
                    ...
                    case 5:
                        userData = _c;
                        if (userId && !(userData === null || userData === void 0 ? void 0 : userData.email))
                            throw new http_errors_1.BadRequest("No email found in this user");
                        console.log({ email: email });
                        return [4 /*yield*/, new mail_controller_1.default().sendHtmlMail({
                                to: (userData === null || userData === void 0 ? void 0 : userData.email) || email,
                                subject: subject,
                                html: body_1,
                            })];
                    case 6:
