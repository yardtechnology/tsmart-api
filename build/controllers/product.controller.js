...
var Product = /** @class */ (function (_super) {
    ...
    Product.prototype.getAllProduct = function (req, res, next) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var _c, storeId, excludeAccessoryIds, excludeAccessoryIdsArrayCheck, products, error_6;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 5, , 6]);
                        _c = req.query, storeId = _c.storeId, excludeAccessoryIds = _c.excludeAccessoryIds;
                        excludeAccessoryIdsArrayCheck = excludeAccessoryIds
                        ...
                        return [4 /*yield*/, _super.prototype.getAllProductsOptimized.call(this, {
                                ...
                                excludeAccessoryIdsArrayCheck: (excludeAccessoryIdsArrayCheck === null || excludeAccessoryIdsArrayCheck === void 0 ? void 0 : excludeAccessoryIdsArrayCheck.map(function (item) { return new mongoose_1.Types.ObjectId(item); })) || [],
                            })];
                    case 1:
                        products = _d.sent();
                        return [3 /*break*/, 4];
    ...
    Product.prototype.productTemp = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    socket = (0, socket_io_client_1.io)("".concat(req.protocol, "://").concat(req.headers.host, "/incoming-job"));
                    ...
                    res.json({ data: "".concat(req.protocol, "://").concat(req.headers.host) });
                }
                catch (error) {
                    next(error);
                }
