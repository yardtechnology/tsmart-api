            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, product_model_1.ProductModel.aggregate(__spreadArray([
                                {
                                    $match: {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        hubId = "63808bd7be93a20006ce2d05";
                        return [4 /*yield*/, product_model_1.ProductModel.updateMany({}, { store: hubId })];
                    case 1:
                        updateData = _a.sent();
