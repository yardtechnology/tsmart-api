...
var ContactUsController = /** @class */ (function () {
    ...
    ContactUsController.prototype.create = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, subject, message, store, email, displayName, createContactUs, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        (0, helper_1.fieldValidateError)(req);
                        _a = req.body, subject = _a.subject, message = _a.message, store = _a.storeId, email = _a.email, displayName = _a.displayName;
