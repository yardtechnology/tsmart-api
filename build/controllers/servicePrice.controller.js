...
var ServicePrice = /** @class */ (function (_super) {
    ...
    ServicePrice.prototype.createServicePrice = function (req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _c, title, description, mrp, salePrice, storeId, serviceId, modelId_1, type, isMostPopular, allServices, imageFile, filePath, imageData, _d, servicePriceData_1, allServicesCheck, createServicePropertyValue, _e, error_1;
                ...
                switch (_f.label) {
                    ...
                    case 4:
                        ...
                        allServicesCheck = allServices
                            ...
                            : undefined;
                        if (!allServicesCheck) return [3 /*break*/, 6];
    ...
    ServicePrice.prototype.getAllServicePrice = function (req, res, next) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var model, _b, serviceId, servicePriceId, serviceArg, _c, servicePriceIds, couponId, checkArrayServicePriceId, matchArray, aggregationQuery, servicePriceData, findSelectedServices, _d, servicePricesReducer, couponCalculation, _e, error_4;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        _f.trys.push([0, 8, , 9]);
                        ...
                        _b = req.query, serviceId = _b.serviceId, servicePriceId = _b.servicePriceId;
                        serviceArg = [];
                        serviceId &&
                            serviceArg.push({
                                $match: {
                ...
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        res.json({
                            status: "SUCCESS",
                            message: "Service price get successfully",
                            data: __assign({ couponCalculation: couponCalculation }, dataServiceSummery),
                        });
                        return [3 /*break*/, 6];
                    case 5:
                        error_5 = _c.sent();
