...
var User = /** @class */ (function (_super) {
    ...
    User.prototype.getMyAccount = function (req, res, next) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var errors, userData, cartCount, error_2;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        res.status(200).json({
                            ...
                            data: __assign(__assign({}, userData === null || userData === void 0 ? void 0 : userData._doc), { cartCount: cartCount }),
                        });
                        return [3 /*break*/, 3];
                    case 2:
                        error_2 = _b.sent();
    ...
    User.prototype.createStoreManager = function (req, res, next) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var errors, managerData, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
    ...
    User.prototype.onlineRecordController = function (req, res, next) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _h, latitude, longitude, location_1, lastOnlineRecord, onlineReportData, endTime, error_7;
