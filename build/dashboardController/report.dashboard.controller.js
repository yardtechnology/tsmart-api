...
var ReportDashboardController = /** @class */ (function () {
    ...
    ReportDashboardController.prototype.reportCount = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, startDate, endDate, argQuery, totalUser, totalJob, totalBrought, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        totalUser = _b.sent();
                        return [4 /*yield*/, order_model_1.OrderModel.find(__assign({ serviceType: "CALL_OUT" }, argQuery)).count()];
                    case 2:
                        totalJob = _b.sent();
                        return [4 /*yield*/, order_model_1.OrderModel.find(__assign({ type: { $in: ["ACCESSORY", "REFURBISH"] } }, argQuery)).count()];
                    case 3:
                        totalBrought = _b.sent();
                        res.json({
                            status: "SUCCESS",
    ...
    ReportDashboardController.prototype.totalBrought = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, startDate, endDate, query_3, totalBrought, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
