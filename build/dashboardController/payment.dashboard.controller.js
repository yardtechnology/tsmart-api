...
var PaymentDashboardController = /** @class */ (function () {
    ...
    PaymentDashboardController.prototype.totalRevenue = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, startDate, endDate, arrayArg, orderDataAccordingStatus, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, order_model_1.OrderModel.aggregate(__spreadArray(__spreadArray([], arrayArg, true), [
                                {
                                    $group: {
                                        _id: null,
                                        total: { $sum: 1 },
                    ...
                    case 1:
                        orderDataAccordingStatus = _b.sent();
                        res.json({
                            status: "SUCCESS",
    ...
    PaymentDashboardController.prototype.refurbishList = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, startDate, endDate, query_1, totalRefurbish, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
    ...
    PaymentDashboardController.prototype.accessoryList = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, startDate, endDate, query_2, accessoryData, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
    ...
    PaymentDashboardController.prototype.inStoreList = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, startDate, endDate, query_3, inStoreData, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
