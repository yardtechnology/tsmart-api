...
var Blog = /** @class */ (function (_super) {
    ...
    Blog.prototype.addCommentRoute = function () {
        this.router.post("/blog/:blogId/comment", this === null || this === void 0 ? void 0 : this.isAuthenticated, this.BlogController.addCommentController);
    };
    //delete comment
    Blog.prototype.deleteCommentRoute = function () {
        this.router.delete("/blog/:blogId/comment/:commentId", this === null || this === void 0 ? void 0 : this.isAuthenticated, this.BlogController.deleteCommentController);
    };
    //get comments
    Blog.prototype.getCommentsRoute = function () {
        this.router.get("/blogs/comments", this === null || this === void 0 ? void 0 : this.isAuthenticated, this === null || this === void 0 ? void 0 : this.BlogController.validateGetBlogCommentsFields, this.BlogController.getCommentsController);
    };
    //get all blogs
