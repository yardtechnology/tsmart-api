...
//           : undefined;
//       const createDevice = await ColorSchema.create({
//         title,
//         description,
//         image: imageData?.url,
...
//       const updateDeviceData = await ColorSchema.findByIdAndUpdate(
//         evaluationId,
//         arg,
//         {
//           runValidators: true,
...
//       const { evaluationId } = req.params;
//       fieldValidateError(req);
//       const deleteEvaluation = await ColorSchema.findByIdAndDelete(
//         evaluationId
//       );
